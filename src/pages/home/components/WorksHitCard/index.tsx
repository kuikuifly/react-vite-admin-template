...
const WorksHitCard: React.FC = () => {
  ...
  const columns: ColumnsType<TableListItem> = [
    {
      title: 'page.home.workshitcard.card.table-column-number',
      dataIndex: 'index',
      width: 80,
      render: (_, record, index) => <>{(pagination.current - 1) * pagination.pageSize + index + 1}</>,
    },
    {
      title: 'page.home.workshitcard.card.table-column-title',
      dataIndex: 'title',
    },
    {
      title: 'page.home.workshitcard.card.table-column-hit',
      dataIndex: 'hit',
    },
  ];

  return (
    <Card className={styles.homeBoxCard} title={'page.home.workshitcard.card-title'}>
      <Table
        size='small'
        rowKey='id'
        columns={columns}
